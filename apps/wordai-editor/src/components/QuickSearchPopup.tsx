...
export const SETTING_I18N_MAP: Record<string, { label: string; description: string }> = {
  ...
  'general.autoSyncEnabled': { label: 'settings.general.auraBrainSync.label', description: 'settings.general.auraBrainSync.description' },
  'general.autoSyncInterval': { label: 'settings.general.auraBrainSync.label', description: 'settings.general.auraBrainSync.description' },
