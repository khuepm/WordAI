  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
      ...
      <div data-setting-id="general.autoSyncEnabled">
        <SectionHeader
          label={t('settings.general.auraBrainSync.label')}
          description={t('settings.general.auraBrainSync.description')}
        />
        <SettingRow icon="psychology" label="">
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flex: 1 }}>
            <span style={{ fontSize: '0.75rem', fontWeight: 500 }}>
              {t('settings.general.auraBrainSync.every')}
            </span>
            <input
              data-setting-id="general.autoSyncInterval"
              type="number"
              defaultValue={30}
              min={5}
              max={60}
            ...
            />
            <span style={{ fontSize: '0.75rem', fontWeight: 500 }}>
              {t('settings.general.auraBrainSync.seconds')}
            </span>
          </div>
          <Toggle checked={true} />
        </SettingRow>
