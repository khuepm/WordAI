...
- [ ] 1. Set up database schema with Lumibase migrations
  - [ ] 1.1 Create migration group 001_users_core
  ...
  - [ ]* 1.2 Write property test for migration idempotence (Property 35)
  ...
  - [ ] 1.4 Create migration group 002_roles_permissions
  ...
  - [ ] 1.5 Create migration group 003_entitlements_sessions
  ...
  - [ ] 1.7 Create migration group 004_audit
